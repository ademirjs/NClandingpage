...
<head>
    ...
    <meta property="og:url" content="https://lp1.naocontratei.com.br/" />
...
Descubra agora se você também está entre os 30% dos brasileiros
                ...
                <form id="lead-form" action="https://naocontratei.com.br/lead/lp/create" method="post" class="lead-form" x-data>
...
/>
                    ...
                    <p id="telefone-erro" class="telefone-erro-msg" style="color:#ff4d4f;font-size:.75rem;margin:-4px 0 8px 40px;min-height:14px" aria-live="polite"></p>
                    ...
                    <button id="lead-submit" type="submit" class="bnt bnt-primary-form" disabled>
            ...
            <div class="tools__grid">
                <a href="" class="card-service">
                    ...
                    <div class="card-text">
                        ...
                        <p>Verifique se há cobranças indevidas em sua conta bancária.</p>
                    </div>
                </a>
                ...
                <a href="" class="card-service">
                    ...
                    <div class="card-text">
                        ...
                        <p>Verifique se há cobranças indevidas em sua conta de TV.</p>
                    </div>
                </a>
                ...
                <a href="" class="card-service">
                    ...
                    <div class="card-text">
                        ...
                        <p>Verifique se há cobranças indevidas em sua conta de água.</p>
                    </div>
                </a>
                <a href="" class="card-service">
                    <div class="card-icon">
                    ...
                    <div class="card-text">
                        ...
                        <p>Verifique se há cobranças indevidas em sua conta de internet.</p>
                    </div>
                </a>
...
(function(){
    ...
    const err = document.getElementById('telefone-erro');
    function digits(){return (tel.value||'').replace(/\D/g,'');}
    function validar(showMsg){
        const d = digits();
        if(!d){
            err.textContent = '';
            btn.disabled = true;
        ...
        if(d.length !== 11){
            if(showMsg) err.textContent = 'Número inválido. Use DDD + 9 dígitos.';
            btn.disabled = true;
            return false;
        }
        err.textContent = '';
    ...
    tel.addEventListener('input', () => validar(false));
  form.addEventListener('submit', (e)=>{ if(!validar(true)){ e.preventDefault(); tel.focus(); }});
})();
</script>
</body>
</html>